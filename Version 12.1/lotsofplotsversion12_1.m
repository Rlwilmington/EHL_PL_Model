...
par = 2;
plot(power_vec(startfile:end),allentries(startfile:end,par+1),'-bo','LineWidth',2);
...
for i = startfile:21
    ...
    KKgap = @(T) (353e-6)*(T-294); % + 1.993429; %2.0118; %from Avinash calculations (E_thermal)
...
hold on
plot(power_vec(startfile:end),QE,'-bo','LineWidth',2);
set(gca,'FontSize',fontsize)
