function [X, RESNORM] = PL_fit_generator(par,const,xdata,ydata,f1,f2,f3,f4,f5,maxevals)
    ...
    fitops = optimoptions('lsqnonlin','maxfunevals',maxevals,'TolFun',1e-8,'TolX',1e-8,'Algorithm','trust-region-reflective');

    %fitops = optimoptions('lsqnonlin','maxfunevals',maxevals,'TolFun',1e-8,'TolX',1e-8,'Display','iter-detailed','Algorithm','trust-region-reflective');
